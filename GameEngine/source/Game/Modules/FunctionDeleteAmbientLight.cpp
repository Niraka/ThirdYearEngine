...
FunctionDeleteAmbientLight::FunctionDeleteAmbientLight(std::vector<ScriptParam>& params) :
...
FunctionDeleteAmbientLight::~FunctionDeleteAmbientLight()
{
}

ScriptVar& FunctionDeleteAmbientLight::execute(ScriptInfoPack& pack)
{
