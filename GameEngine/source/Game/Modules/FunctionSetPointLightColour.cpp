...
FunctionSetPointLightColour::FunctionSetPointLightColour(std::vector<ScriptParam>& params) :
...
FunctionSetPointLightColour::~FunctionSetPointLightColour()
{
}

ScriptVar& FunctionSetPointLightColour::execute(ScriptInfoPack& pack)
{
