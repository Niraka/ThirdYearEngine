...
FunctionDeleteSpotLight::FunctionDeleteSpotLight(std::vector<ScriptParam>& params) :
...
FunctionDeleteSpotLight::~FunctionDeleteSpotLight()
{
}

ScriptVar& FunctionDeleteSpotLight::execute(ScriptInfoPack& pack)
{
