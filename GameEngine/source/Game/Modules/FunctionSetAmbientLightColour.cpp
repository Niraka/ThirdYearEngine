...
FunctionSetAmbientLightColour::FunctionSetAmbientLightColour(std::vector<ScriptParam>& params) :
...
FunctionSetAmbientLightColour::~FunctionSetAmbientLightColour()
{
}

ScriptVar& FunctionSetAmbientLightColour::execute(ScriptInfoPack& pack)
{
