...
FunctionDeletePointLight::FunctionDeletePointLight(std::vector<ScriptParam>& params) :
...
FunctionDeletePointLight::~FunctionDeletePointLight()
{
}

ScriptVar& FunctionDeletePointLight::execute(ScriptInfoPack& pack)
{
