...
public:
	...
	*/
	...
	@param bmp The bitmap to populate with the result
	@param filePath The path to bitmap file to load
	@return True if the load was successful, false otherwise */
	static bool bitmapFromFile(Bitmap& bmp, std::string filePath);
